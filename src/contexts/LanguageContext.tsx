...
const translations = {
  pt: {
    ...
    "services.dataeng.description": "Estruturação de pipelines, modelagem, padronização e qualidade de dados para garantir confiabilidade e visibilidade operacional.",
    "services.dataeng.expand": "O trabalho envolve organizar dados em camadas (raw, clean, metrics), criar pipelines de ETL, definir padrões de nomenclatura e garantir qualidade desde a origem. O objetivo é transformar dados dispersos em uma base confiável para análise e tomada de decisão.",
    "services.integrations.title": "Integrações",
    "services.integrations.description": "Conexão entre sistemas e automações com low-code, filtros condicionais, lógicas avançadas e tratamento de exceções.",
    "services.integrations.expand": "Integrações são construídas com foco em robustez: filtros condicionais, validações, webhooks e APIs quando necessário, além de tratamento de exceções para garantir que os fluxos não quebrem silenciosamente. Automações low-code são utilizadas como base, mas com lógica avançada quando o cenário exige.",
    ...
    "services.automation.expand": "As automações são pensadas como parte de um sistema maior, evitando soluções frágeis ou difíceis de manter.",
    ...
    "services.workshops.expand": "Os conteúdos são adaptados ao contexto do time e têm foco prático, aplicável à rotina e aos desafios reais da operação.",
  ...
  en: {
    ...
    "services.dataeng.description": "Pipeline structuring, modeling, standardization, and data quality to ensure reliability and operational visibility.",
    "services.dataeng.expand": "The work involves organizing data into layers (raw, clean, metrics), creating ETL pipelines, defining naming standards, and ensuring quality from the source. The goal is to turn scattered data into a reliable foundation for analysis and decision-making.",
    "services.integrations.title": "Integrations",
    "services.integrations.description": "Connecting systems and automations with low-code, conditional filters, advanced logic, and exception handling.",
    "services.integrations.expand": "Integrations are built with a focus on robustness: conditional filters, validations, webhooks and APIs when needed, plus exception handling to ensure flows don't break silently. Low-code automations are used as a foundation, but with advanced logic when the scenario demands it.",
    ...
    "services.automation.expand": "Automations are designed as part of a larger system, avoiding fragile or hard-to-maintain solutions.",
    ...
    "services.systems.expand": "The goal is to align operations, data, and teams — avoiding rework and information loss throughout the flow.",
    ...
    "services.workshops.expand": "Content is adapted to the team's context with a practical focus, applicable to daily routines and real operational challenges.",
